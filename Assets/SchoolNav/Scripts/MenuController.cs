...
namespace SchoolNav
{
    public class MenuController : MonoBehaviour
    {
        ...
        private void ASSetHttpIP(string httpIP){
            game.SaveHttpIP(httpIP);
        }
        private void ASSetMapId(string mapId){
            game.SaveMapID(mapId);
        }
        private void ASSetMapName(string mapName){
            game.SaveMapName(mapName);
        }
        private void ASSetTargetPosition(string tp){
            PlayerPrefs.SetString("TargetPosition", tp);
        }
